<template>
	<div :class="userAddClass">
		...
		<transition name="mu-select-fade">
		    <div class="mu-select-body" v-if="show">
		    	<ul>
...
<script>
	...
	export default {
		...
		,data(){
			let options       =  [{"value":1,"label":"测试"},{"value":11,"label":"测试"},{"value":12,"label":"测试","disabled":true},{"value":13,"label":"测试","isSelected":true},{"value":15,"label":"测试"}]
